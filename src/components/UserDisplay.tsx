...
export default function UserDisplay({ loading, user }: UserDisplayProps) {
    return (
        <>
            <div className="bg-white dark:bg-softDark rounded-lg px-6 pt-8 pb-10 min-w-[327px] max-w-[730px] shadow-2xl mx-6 md:mx-auto xl:px-12">
                ...
                <div className="flex justify-around md:justify-center md:gap-32 md:pl-8 text-center bg-softGray rounded-lg p-4 my-6 dark:text-white dark:bg-darkPrimary xl:w-[480px] xl:ml-36 xl md:text-left">
                    {
                        loading ? < Spinner /> :
                            <>
                                <div>
                        ...
                        <>
                            <div className="md:grid md:grid-cols-2 xl:w-[480px] xl:ml-36">
                                ...
                                <div className="flex gap-5 mb-4">
                                    ...
                                    <a href={user.blog} className={user.blog === null ? "text-secondaryText" : "text-primaryActive hover:cursor-pointer hover:underline"}>
